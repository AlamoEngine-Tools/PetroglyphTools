...
public class FileHolderBaseTest
{
    ...
    public void Test__Ctor_ThrowsArgumentNullException()
    {
        ...
        ExceptionUtilities.Assert_CtorException<ArgumentNullException>(() => new Mock<FileHolderBase<IFileHolderParam, object, TestFileType>>(model, new TestParam("test"), sp).Object);

        var spMock = new Mock<IServiceProvider>();
        spMock.Setup(s => s.GetService(typeof(IFileSystem))).Returns(fs);

        ExceptionUtilities.Assert_CtorException<ArgumentNullException>(() => new Mock<FileHolderBase<IFileHolderParam, object, TestFileType>>(model, null!, spMock.Object).Object);
    }
    ...
    { 
        ...
        ExceptionUtilities.Assert_CtorException<InvalidOperationException>(() => new Mock<FileHolderBase<IFileHolderParam, object, TestFileType>>(model, new TestParam("test"), spMock.Object).Object);
    }
    ...
    public void Test__Ctor_InvalidPath(string path, Type type)
    {
        ...
        ExceptionUtilities.Assert_CtorException(type, () => new Mock<FileHolderBase<IFileHolderParam, object, TestFileType>>(model, new TestParam(path), sp.Object).Object);
    }
