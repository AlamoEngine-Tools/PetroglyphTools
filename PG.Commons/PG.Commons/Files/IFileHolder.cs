...
public interface IFileHolder<out TModel, out TAlamoFileType> : IFileHolder where TAlamoFileType : IAlamoFileType
{
    /// <summary>
    ...
    /// <summary>
    /// The file name excluding the full path, eg. "c:/my/path/myfile.txt"
    /// </summary>
    string FilePath { get; }
}