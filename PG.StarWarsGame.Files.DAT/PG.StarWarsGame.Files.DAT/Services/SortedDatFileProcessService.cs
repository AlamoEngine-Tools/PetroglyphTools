...
namespace PG.StarWarsGame.Files.DAT.Services
{
    ...
    {
        public SortedDatFileProcessService([CanBeNull] IFileSystem fileSystem = null,
            [CanBeNull] ILoggerFactory loggerFactory = null) : base(
        ...
        public SortedDatFileHolder LoadFromFile(string filePath)
        {
            ...
            Logger?.LogInformation("Attempting to load a {0} instance from {1}", nameof(SortedDatFileHolder),
                filePath);
