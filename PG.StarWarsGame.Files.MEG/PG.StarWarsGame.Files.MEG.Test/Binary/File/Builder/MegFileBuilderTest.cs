...
namespace PG.StarWarsGame.Files.MEG.Test.Binary.File.Builder
{
    ...
    public class MegFileBuilderTest
    {
        ...
        {
            MegFileHolder megFileHolder = new MegFileHolder(MegTestConstants.BASE_PATH, "test");
        ...
        public void FromHolder_Test__FileHeaderIsBinaryEquivalent()
        {
            MegFileHolder megFileHolder =
                new MegFileHolder(MegTestConstants.BASE_PATH, "FromHolder_Test__FileHeaderIsBinaryEquivalent");
            megFileHolder.Content.Add(new MegFileDataEntry("data/xml/campaignfiles.xml",
                MegTestConstants.FILE_PATH_CAMPAIGNFILES));
            megFileHolder.Content.Add(new MegFileDataEntry("data/xml/gameobjectfiles.xml",
                MegTestConstants.FILE_PATH_GAMEOBJECTFILES));
            ...
            byte[] readMegFile = m_fileSystem.File.ReadAllBytes(m_fileSystem.Path.Combine(MegTestConstants.BASE_PATH,
