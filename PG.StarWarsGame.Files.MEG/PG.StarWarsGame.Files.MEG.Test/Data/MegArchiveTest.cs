...
public class MegArchiveTest
{
    ...
    {
        var entry1 = MegDataEntryTest.CreateEntry("path", new Crc32(123), 456, 789);
        var entry2 = MegDataEntryTest.CreateEntry("test", new Crc32(987), 123, 456);
    ...
    public void Test_IndexOf_Contains()
    {
        ...
        var entry3 = MegDataEntryTest.CreateEntry("new", new Crc32(456), 789, 123);
    ...
    {
        var megFiles = files.Select(f => MegDataEntryTest.CreateEntry(f)).ToList();
