...
[TestClass]
public class MegFileDataEntryTest
{
    [TestMethod]
    ...
    public void Test_Equals_HashCode()
    {
        ...
        var entry2 = new MegFileDataEntry(new Crc32(123), "path", 456, 789);

        var entry3 = new MegFileDataEntry(new Crc32(456), "path", 456, 789);
        var entry4 = new MegFileDataEntry(new Crc32(123), "test", 456, 789);
        var entry5 = new MegFileDataEntry(new Crc32(123), "path", 123, 789);
        var entry6 = new MegFileDataEntry(new Crc32(123), "path", 456, 123);
        var entry7 = new MegFileDataEntry(new Crc32(123), "PATH", 456, 789);
        ...
        Assert.AreNotEqual(entry1, (MegFileDataEntry?)null);
    ...
    public void Test_CompareTo()
    {
        ...
        var entry3 = new MegFileDataEntry(new Crc32(0), "path", 456, 789);
        var entry4 = new MegFileDataEntry(new Crc32(789), "path", 456, 789);
