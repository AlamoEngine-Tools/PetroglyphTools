...
public class MegFileHolderTest
{
    ...
    //{
    //    Assert.IsFalse(s_holder.TryGetFirstMegFileDataEntryWithMatchingName(fileMatch, out var _));
    //}
    //[TestMethod]
    //[DataRow(FILE_NAME_1)]
    //[DataRow(FILE_NAME_2)]
    ...
    //{
    //    Assert.IsTrue(s_holder.TryGetFirstMegFileDataEntryWithMatchingName(fileMatch, out var _));
    //}
    ...
    //{
    //    Assert.IsFalse(s_holder.TryGetAllMegFileDataEntriesWithMatchingName(fileMatch, out var _));
    //}
    //[TestMethod]
    //[DataRow(FILE_NAME_1)]
    //[DataRow(FILE_NAME_2)]
    ...
    //{
    //    Assert.IsTrue(s_holder.TryGetAllMegFileDataEntriesWithMatchingName(fileMatch, out var _));
    //}
}