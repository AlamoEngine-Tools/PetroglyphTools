...
public class EmpireAtWarMegFileInformationValidatorTest : BinaryMegFileInformationValidatorTestBase
{
    ...
    {
        return new EmpireAtWarMegFileInformationValidator(ServiceProvider);
    }
    ...
    [Theory]
    [MemberData(nameof(BaseInvalidTestData), MemberType = typeof(BinaryMegFileInformationValidatorTestBase))]
