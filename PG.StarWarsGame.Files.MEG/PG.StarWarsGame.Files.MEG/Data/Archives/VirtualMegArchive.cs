...
internal sealed class VirtualMegArchive : MegDataEntryHolderBase<MegFileDataEntry>, IVirtualMegArchive
{
    /// <summary>
    ...
    internal VirtualMegArchive(IList<MegFileDataEntry> files) : base(files)
    {
    }
}