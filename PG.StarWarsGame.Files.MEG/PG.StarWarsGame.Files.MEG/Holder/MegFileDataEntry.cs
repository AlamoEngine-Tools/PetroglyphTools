...
namespace PG.StarWarsGame.Files.MEG.Holder
{
    ...
    public sealed class MegFileDataEntry
    {
        ...
        ///     when the containing meg file resides in c:/My/Game/Data
        /// </param>
        /// <param name="offset">
        ...
        /// </param>
        /// <param name="size">
        ///     Optional file size in byte. If not set, this is 0. If a *.MEG file is read from disc
        ///     using the standard implementation of the <see cref="PG.StarWarsGame.Files.MEG.Services.IMegFileProcessService" />
        ///     this is set to the size in bytes of the packaged file.
        /// </param>
