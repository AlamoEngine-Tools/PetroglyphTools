...
namespace PG.StarWarsGame.Files.MEG.Services
{
    ...
    public interface IMegFileProcessService
    {
        ...
        void PackFilesAsMegArchive([NotNull] string megArchiveName, [NotNull] string baseDirectoryPath, [NotNull] List<string> absoluteFilePaths, [NotNull] string targetDirectory);
        ...
        void UnpackMegFile([NotNull] MegFileHolder holder, [NotNull] string targetDirectory, [NotNull] string fileName, bool preserveDirectoryHierarchy = true);
