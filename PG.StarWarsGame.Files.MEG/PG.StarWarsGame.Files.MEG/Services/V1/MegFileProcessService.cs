...
namespace PG.StarWarsGame.Files.MEG.Services.V1
{
    ...
    public sealed class MegFileProcessService : AService<MegFileProcessService>, IMegFileProcessService
    {
        ...
        public MegFileHolder Load(string filePath)
        {
            ...
            using (BinaryReader reader = new BinaryReader(FileSystem.FileStream.Create(filePath, FileMode.Open)))
            {
            ...
            MegFileHolder holder = new MegFileHolder(FileSystem.Path.GetDirectoryName(filePath),
        ...
        private void CreateTargetDirectoryIfNotExists(string targetDirectory)
        {
            ...
            Logger?.LogWarning($"The given directory \"{targetDirectory}\" does not exist. Trying to create it.");
