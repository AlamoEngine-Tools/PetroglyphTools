...
{
    public sealed class HardPointTargetReticleEnemyTextureXmlTagDescriptor : AXmlTagDescriptor
    {
        private const string KEY_ID = "HardPoint_Target_Reticle_Enemy_Texture";
