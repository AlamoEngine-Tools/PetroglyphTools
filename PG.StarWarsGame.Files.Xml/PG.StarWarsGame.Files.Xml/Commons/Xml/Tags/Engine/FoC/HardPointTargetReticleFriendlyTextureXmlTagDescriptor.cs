...
public sealed class HardPointTargetReticleFriendlyTextureXmlTagDescriptor : AXmlTagDescriptor
{
    private const string KEY_ID = "HardPoint_Target_Reticle_Friendly_Texture";
