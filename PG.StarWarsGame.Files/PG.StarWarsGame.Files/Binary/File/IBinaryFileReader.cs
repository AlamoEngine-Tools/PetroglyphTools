...
/// <summary>
/// Represents a reader that is capable of converting a stream of bytes into a binary model.
/// </summary>
...
public interface IBinaryFileReader<out TBinaryModel> where TBinaryModel : IBinaryFile
{
    ...
    /// </summary>
    /// <param name="byteStream">The stream that contains the binary data.</param>
